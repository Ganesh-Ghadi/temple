...
const Index = () => {
  ...
  const {
    data: AnteshteeDatesData,
    isLoading: isAnteshteeDatesDataLoading,
    isError: isAnteshteeDatesDataError,
  } = useQuery({
    queryKey: ["anteshteeDates", currentPage, search], // This is the query key
    queryFn: async () => {
      try {
        const response = await axios.get("/api/anteshtee_dates", {
          headers: {
  ...
  return (
    <>
      <div className="w-full p-5">
        <div className="px-5 mt-16 dark:bg-background pt-1 w-full bg-white shadow-xl border rounded-md">
          ...
          <Table className="mb-2">
            ...
            <TableHeader className="dark:bg-background bg-gray-100  rounded-md">
              <TableRow>
                <TableHead className="">Day 9 Amount</TableHead>
                <TableHead className="">Day 10 Amount</TableHead>
                <TableHead className="">Day 11 Amount</TableHead>
                <TableHead className="">Day 12 Amount</TableHead>
                <TableHead className="">Day 13 Amount</TableHead>
